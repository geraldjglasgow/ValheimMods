...
- Gameplay settings (party size, friendly fire, invite timeout) are server-synced and lockable; display settings
  (colors, panel layout, ping key) are always local to each player.
