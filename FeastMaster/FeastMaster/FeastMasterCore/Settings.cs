...
{
    /// <summary>
    /// The numbered global sections 1 to 8. This file holds the regeneration sections (health, stamina, eitr);
    /// <c>SettingsMore.cs</c> holds costs, base values, skills, world rates and display. Every gameplay entry is
