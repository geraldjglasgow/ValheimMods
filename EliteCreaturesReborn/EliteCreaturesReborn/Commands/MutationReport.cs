    ...
    public static class MutationReport
    {
        public static string Line(BiomeRules r, CreatureTraits t, Mutation m)
        {
            ...
            return m switch
            {
                ...
                Mutation.Leeching => $"Leeching: regen {Enhance.Magnitude(r, t, m, Fields.Regen):0.0}%/s, lifesteal {Enhance.Magnitude(r, t, m, Fields.Lifesteal):0.0}%{tag}",
                ...
                Mutation.Plated => $"Plated: armour {Enhance.Magnitude(r, t, m, Fields.Armour):0} at full hp, damage +{Enhance.Magnitude(r, t, m, Fields.Damage):0}% at empty{tag}",
